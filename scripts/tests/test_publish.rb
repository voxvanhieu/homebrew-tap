...
# Exercises the publisher against trusted, stale, and unrelated pull requests.
class PublishTest < Minitest::Test
  def run_resolver(overrides = {}, pr_changes = {},
                   files = [{ filename: "Formula/code-a-cv.rb", status: "modified" }])
